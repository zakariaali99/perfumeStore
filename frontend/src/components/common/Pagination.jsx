...
const Pagination = ({ currentPage, totalPages, onPageChange }) => {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-6 py-5 bg-white dark:bg-dark-800 border-t border-gold-100 dark:border-dark-600 rounded-b-[32px] shadow-sm">
            {/* Page Count Badge */}
