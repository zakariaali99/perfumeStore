        ...
        >
          ...
          {variant === 'drawer' ? (
            ...
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className={`relative bg-white dark:bg-dark-800 w-full ${maxWidth} ${rounded} shadow-2xl z-10 overflow-y-auto border border-gold-200/50 dark:border-dark-600 max-h-[90vh]`}
            >
              {children}
            </motion.div>
          )}
