                                            ...
                                            <div className="bg-white dark:bg-dark-800 border border-gold-50 dark:border-dark-600 p-6 rounded-[40px] shadow-sm">
                                                <form onSubmit={handleAddInteraction} className="space-y-4">
                                                    <input
                                                        ...
                                                        className="w-full bg-cream-50 dark:bg-dark-700 border border-gold-100 dark:border-dark-600 p-3 rounded-2xl focus:outline-none focus:ring-2 focus:ring-gold-500/20 text-sm font-bold text-text-primary dark:text-cream-50"
                                                    />
                                                    <select
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="w-full bg-cream-50 dark:bg-dark-700 border border-gold-100 dark:border-dark-600 p-3 rounded-2xl focus:outline-none focus:ring-2 focus:ring-gold-500/20 text-sm min-h-[80px] font-bold text-text-primary dark:text-cream-50"
                                                    ></textarea>
                                                    <button type="submit" className="w-full bg-gold-600 text-white font-black py-3 rounded-2xl hover:bg-gold-700 transition-all text-xs flex items-center justify-center gap-2 shadow-lg shadow-gold-600/20 active:scale-95">
