...
import { Plus, Edit2, Trash2, Upload, Check, Search } from 'lucide-react';
...
const DashboardBrands = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Search */}
            <div className="bg-white dark:bg-dark-700 p-4 rounded-3xl border border-gold-200 dark:border-dark-600">
            ...
            <div className="bg-white dark:bg-dark-700 rounded-[32px] border border-gold-200 dark:border-dark-600 shadow-sm overflow-hidden text-right">
                <div className="overflow-x-auto">
                    <table className="w-full min-w-0">
                        <thead className="bg-cream-50 dark:bg-dark-800 border-b border-gold-100 dark:border-dark-600">
                            <tr>
                                ...
                                brands.map((brand) => (
                                    <tr key={brand.id} className="hover:bg-gold-50/20 dark:hover:bg-dark-600 transition-colors">
                                        <td className="px-4 md:px-8 py-5">
                                            <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl overflow-hidden border border-gold-200 dark:border-dark-600 bg-white dark:bg-dark-800 p-1 md:p-2 flex items-center justify-center">
                                                {brand.logo ? (
            ...
            <Modal isOpen={showModal} onClose={handleCloseModal}>
                <Modal.Header title={currentBrand ? 'تعديل البراند' : 'إضافة براند جديد'} subtitle="Brand Management" onClose={handleCloseModal} />
                <Modal.Body>
