...
from .views import (
    CategoryViewSet, BrandViewSet, FragranceFamilyViewSet, ProductViewSet,
    AdminProductViewSet, AdminVariantViewSet, AdminCategoryViewSet, AdminBrandViewSet
)

router = DefaultRouter()
router.register('categories', CategoryViewSet)
router.register('brands', BrandViewSet)
router.register('fragrance-families', FragranceFamilyViewSet)
